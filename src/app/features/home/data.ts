import type { HeroSlide, HomeProduct, SidebarCategory } from './models';
...
export const HEADPHONES: HomeProduct[] = [
  {
    id: 1,
...
export const TABLETS: HomeProduct[] = [
  {
    id: 11,
...
export const LAPTOPS: HomeProduct[] = [
  {
    id: 21,
