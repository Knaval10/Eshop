import { FeatureCard, Stat, TeamMember, TimelineItem } from './models';
...
export const TIMELINE_LEFT: TimelineItem[] = [
  {
    year: '1997',
  ...
  { year: '2006', description: 'Crossed $10M in annual revenue and expanded to three new cities.' },
  {
    year: '2010',
...
export const TIMELINE_RIGHT: TimelineItem[] = [
  {
    year: '2014',
